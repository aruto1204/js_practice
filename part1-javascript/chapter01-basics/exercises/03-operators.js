...
// == と === の違いを確認
console.log('num1 == num2:', /* ここにコードを書く */);
console.log('num1 === num2:', /* ここにコードを書く */);
...
// 年齢が20歳以上でかつ免許を持っている
const canDrive = /* ここにコードを書く */;

// 免許を持っているか、または保険に加入している
const hasEitherDocument = /* ここにコードを書く */;

// 免許を持っていない
const noLicense = /* ここにコードを書く */;
...
const result = /* ここにコードを書く */;

console.log('結果:', result);

// 年齢によるメッセージを三項演算子で作成
const personAge = 18;
const ageMessage = /* 20歳以上なら '成人'、未満なら '未成年' */;
